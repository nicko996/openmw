...
namespace MWRender
{
    ...
    InventoryPreview::InventoryPreview(osg::Group* parent, Resource::ResourceSystem* resourceSystem,
        const MWWorld::Ptr& character, int sizeX, int sizeY)
        : CharacterPreview(parent, resourceSystem, character, sizeX, sizeY,
            osg::Vec3f(0, 700, 71), osg::Vec3f(0, 0, 71))
    {
    }
